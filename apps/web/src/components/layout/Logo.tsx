  ...
  return (
    ...
    >
      ...
      <g id="text-brand" transform="translate(85, 52)">
        <text x="0" y="0" className="blue-text text-font" fontSize="36">
          Et SH
        </text>
        <text x="98" y="0" className="orange-accent text-font" fontSize="36">
          op
        </text>
        <text x="145" y="0" className="orange-accent text-font" fontSize="42">
          !
        </text>
      </g>
    </svg>
