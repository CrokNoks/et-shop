...
import { BuildingStorefrontIcon, ChevronLeftIcon, Squares2X2Icon, BookOpenIcon } from '@heroicons/react/24/outline';
    ...
    return (
      <div className="flex min-h-screen bg-gray-50">
        ...
        <main className="flex-1 p-12 flex justify-center items-center">
          <p className="text-gray-400 italic animate-pulse text-xl font-bold">Chargement du magasin...</p>
        </main>
      </div>
    );
  }
          ...
          <header className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-gray-500 font-medium">Configuration personnalisée du magasin</p>
              </div>
            </div>
          </header>
